...
150~systems with complete capability data across the eight discriminating
features defined in \S\ref{sec:long-tail}.  Systems are grouped by category
and sorted alphabetically within each group.

\begin{table*}[!t]
\centering
\caption{Per-system capability matrix for 148 classified systems.
...
Memoria              & A & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           & $\bullet$ \\
...
RecallM              & A &           & $\bullet$ & $\bullet$ &           &           &           & $\bullet$ &           \\
...
Qwen-Agent           & N & $\bullet$ &           &           &           &           &           &           &           \\
\midrule
\multicolumn{10}{@{}l}{\textit{Coding Agent Memory (26)}} \\
AgentMemory          & M & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &           \\
Augment Code         & A & $\bullet$ & $\bullet$ &           &           &           &           &           & $\bullet$ \\
Basic Memory         & A &           & $\bullet$ & $\bullet$ &           &           &           &           &           \\
bellamem             & A & $\bullet$ & $\bullet$ & $\bullet$ &           &           &           & $\bullet$ &           \\
Beads                & A & $\bullet$ & $\bullet$ & $\bullet$ &           & $\bullet$ & $\bullet$ &           &           \\
Capy-Cortex          & A & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &           &           &           \\
chum-mem             & M & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &           & $\bullet$ &           \\
...
FadeMem              & A & $\bullet$ & $\bullet$ &           &           &           & $\bullet$ &           &           \\
G-Memory             & A & $\bullet$ & $\bullet$ &           &           &           &           & $\bullet$ &           \\
GAM                  & M & $\bullet$ & $\bullet$ & $\bullet$ &           & $\bullet$ &           &           &           \\
...
Hindsight            & M & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &           &           & $\bullet$ & $\bullet$ \\
ID-RAG               & A & $\bullet$ & $\bullet$ & $\bullet$ &           &           &           &           & $\bullet$ \\
Kumiho               & M & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &           & $\bullet$ &           \\
LightMem             & A & $\bullet$ & $\bullet$ &           &           & $\bullet$ & $\bullet$ &           &           \\
LightRAG             & M &           & $\bullet$ & $\bullet$ & $\bullet$ &           &           &           &           \\
MaRS                 & A & $\bullet$ & $\bullet$ &           &           &           & $\bullet$ &           &           \\
...
Oblivion             & A & $\bullet$ &           &           &           &           & $\bullet$ &           &           \\
O-Mem                & A & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           & $\bullet$ \\
PersonaRAG           & A & $\bullet$ & $\bullet$ &           &           &           &           &           & $\bullet$ \\
SimpleMem            & A & $\bullet$ & $\bullet$ &           & $\bullet$ & $\bullet$ & $\bullet$ &           &           \\
SuperLocalMemory     & M & $\bullet$ & $\bullet$ &           & $\bullet$ &           & $\bullet$ &           &           \\
SYNAPSE              & M & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &           &           \\
APEX-MEM             & M & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &           & $\bullet$ &           \\
FLEX                 & A & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           &           \\
FOREVER              & A & $\bullet$ &           &           &           &           & $\bullet$ &           &           \\
H-EPM                & M & $\bullet$ & $\bullet$ & $\bullet$ &           & $\bullet$ &           &           &           \\
MemEvolve            & M & $\bullet$ & $\bullet$ &           & $\bullet$ & $\bullet$ &           &           &           \\
MemoBrain            & A & $\bullet$ &           &           &           & $\bullet$ &           &           &           \\
Memory Worth         & A & $\bullet$ &           &           &           &           & $\bullet$ &           &           \\
MemP                 & A & $\bullet$ &           &           &           & $\bullet$ &           &           &           \\
Nemori               & A & $\bullet$ & $\bullet$ & $\bullet$ &           & $\bullet$ &           &           &           \\
NGC                  & N &           &           &           &           &           & $\bullet$ &           &           \\
ReasoningBank        & A & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           &           \\
RMM                  & A & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           &           \\
Sophia               & M & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           &           \\
SSGM                 & A & $\bullet$ &           &           &           &           &           & $\bullet$ &           \\
TSM                  & A & $\bullet$ & $\bullet$ & $\bullet$ &           & $\bullet$ &           &           &           \\
U-Mem                & A & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           &           \\
\midrule
\multicolumn{10}{@{}l}{\textit{Reinforcement-Learned Memory (6)}} \\
AtomMem              & M & $\bullet$ &           &           &           & $\bullet$ & $\bullet$ &           &           \\
Live-Evo             & A & $\bullet$ &           &           &           &           & $\bullet$ &           &           \\
MEM1                 & M & $\bullet$ &           &           &           & $\bullet$ & $\bullet$ &           &           \\
MemAgent (ICLR)      & N &           &           &           &           &           & $\bullet$ &           &           \\
MemRL                & A & $\bullet$ &           &           &           &           & $\bullet$ &           &           \\
MemSearcher          & M & $\bullet$ & $\bullet$ &           & $\bullet$ & $\bullet$ &           &           &           \\
\midrule
\multicolumn{10}{@{}l}{\textit{Multi-Agent Memory (4)}} \\
Collaborative Mem.   & M & $\bullet$ & $\bullet$ & $\bullet$ &           &           &           &           &           \\
Intrinsic Mem.\ Ag.  & A & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           &           \\
LEGOMem              & A & $\bullet$ &           &           &           & $\bullet$ &           &           &           \\
LLMA-Mem             & M & $\bullet$ & $\bullet$ &           &           & $\bullet$ &           &           &           \\
\midrule
\multicolumn{10}{@{}l}{\textit{Embodied and Multimodal Memory (3)}} \\
3DLLM-Mem            & M & $\bullet$ & $\bullet$ &           & $\bullet$ &           &           &           &           \\
MemVerse             & M & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &           &           &           & $\bullet$ \\
RoboMemory           & M & $\bullet$ & $\bullet$ & $\bullet$ &           &           &           &           &           \\
\bottomrule
\end{tabular}
\end{table*}
...
capability: only 14 of 133~systems implement it (Mem0, Zep/Graphiti,
...
\end{axis}
\end{tikzpicture}
\caption{Number of classified systems by category.  Research architectures (43)
and dedicated memory systems (39) together account for the majority of the
corpus.  Framework modules and file-based tools are underrepresented,
consistent with memory being an auxiliary concern in orchestration and IDE
contexts.}
\label{fig:category-scores}
\end{figure}

Figure~\ref{fig:category-scores} summarizes the category-level pattern:
research architectures and dedicated systems together account for 82 of
148 classified systems, while framework modules and coding tools remain
underrepresented---consistent with memory being a secondary concern in
orchestration and development tool contexts.
...
% Quadrant labels
\node[font=\scriptsize\itshape, gray] at (axis cs:0.5,4.2) {Lifecycle-focused};
\node[font=\scriptsize\itshape, gray] at (axis cs:3.5,4.2) {Full-stack};
...
% Quadrant dividers
\draw[gray, dashed] (axis cs:2,-0.5) -- (axis cs:2,4.5);
...
\addplot[only marks, mark=pentagon*, purple!70, mark size=3pt] coordinates {
    ...
    (2,1.0)    % FadeMem (jitter)
    (4,2.05)   % Hindsight (jitter)
    (4,1.1)    % MAGMA (jitter)
    (2,1.1)    % MaRS (jitter)
    (1,1.0)    % Oblivion (jitter)
    (3,1.0)    % SuperLocalMemory (jitter)
};
...
\node[font=\tiny, anchor=south west] at (axis cs:4.05,4) {Mem0};
\node[font=\tiny, anchor=south west] at (axis cs:4.05,2.05) {Hindsight};
...
1.6 features, Advanced 3.2, and Modular 4.3---confirming that retrieval
sophistication is a reliable proxy for overall architectural investment
in memory lifecycle operations.

\begin{table}[!t]
\centering
\caption{Mean feature breadth by RAG tier for 148 classified systems
with complete matrix records.
...
across the 148 classified systems.  Three correlations are notable.
First, graph structure and fusion are moderately co-occurrent (25 of 44
graph systems also use fusion, 57\%), confirming that graph traversal
provides an additional retrieval signal that motivates principled fusion.
Second, contradiction resolution remains the rarest feature (16 systems)
and is almost always accompanied by semantic storage (15 of 16,
94\%)---consistent with contradiction detection requiring a declarative
fact store to compare against.  Third, consolidation and forgetting
partially co-occur (19 systems implement both), but the majority of
consolidation systems (31 of 50, 62\%) do not implement explicit
forgetting, suggesting that memory pruning and knowledge promotion are
treated as orthogonal concerns in many architectures.

\begin{table}[!t]
\centering
\caption{Feature co-occurrence matrix (lower triangle) for 148 classified
systems.  Diagonal (bold) shows total count per feature.  Notable:
Graph $\leftrightarrow$ Fusion = 25/44 (57\%);
Contradiction $\rightarrow$ Semantic = 15/16 (94\%).}
...
\midrule
Episodic      & \textbf{129} \\
Semantic      &  84 & \textbf{98} \\
Graph         &  34 & 42 & \textbf{44} \\
Fusion        &  36 & 40 & 25 & \textbf{42} \\
Consolidation &  49 & 42 & 17 & 16 & \textbf{50} \\
Forgetting    &  46 & 32 & 12 & 16 & 19 & \textbf{50} \\
Contradiction &  13 & 15 & 11 &  9 &  8 &  5 & \textbf{16} \\
Preference    &  31 & 22 &  7 & 12 & 10 & 14 &  2 & \textbf{32} \\
\bottomrule
\end{tabular}
\end{table}
...
The visualization includes the full 150-system matrix with sortable
