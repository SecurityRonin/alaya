...
\begin{table*}[!t]
\centering
\caption{Per-system capability matrix for 104 classified systems.
...
\midrule
\multicolumn{10}{@{}l}{\textit{Research Architectures (42)}} \\
...
capability: only 6 of 104~systems implement it (Mem0, Zep/Graphiti,
