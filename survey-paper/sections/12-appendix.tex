...
replications), raw per-question results, judge logs, and the complete
system coding spreadsheet are available in the project
repository~\cite{alaya2026}.  The repository includes a
\texttt{README} with exact reproduction steps, dependency versions, and
the \texttt{all-MiniLM-L6-v2} model checkpoint hash used for na\"ive
RAG embeddings.
