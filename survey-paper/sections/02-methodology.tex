...
138 systems. Table~\ref{tab:excluded} lists deliberate exclusions for
systems that required full-text review before exclusion. The complete
system list with per-system coding labels is in the system matrix
